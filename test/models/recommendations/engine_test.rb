...
module Recommendations
  class EngineTest < ActiveSupport::TestCase
    ...
    def test_recommends_tipi_to_rafe
      ...
      assert_equal test_data.tipi_product, top_recommendation.product
    end
    ...
    def test_recommends_incense_to_ely
      ...
      assert_equal test_data.incense_product, top_recommendation.product
    end
