  ...
  class ProfileTraits::TopicsController < ApplicationController
    ...
    def create
      ...
      if @profile_traits_topic.save
        redirect_to profile_traits_topics_path, notice: 'Topic was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      if @profile_traits_topic.update(profile_traits_topic_params)
        redirect_to profile_traits_topics_path, notice: 'Topic was successfully updated.'
      else
        render :edit
      end
    end
    ...
    def destroy
      ...
      redirect_to profile_traits_topics_url, notice: 'Topic was successfully destroyed.'
    end
