module TraitTrainingSetResponseImpactsHelper
  ...
  def fields_partial_for_question_type
    ...
    when SurveyQuestions::MultipleChoice then 'trait_training_set_response_impacts/multiple_choice_fields'
    when SurveyQuestions::Range then 'trait_training_set_response_impacts/range_fields'
    end
  end
