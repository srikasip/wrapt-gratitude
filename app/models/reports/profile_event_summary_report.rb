module Reports
  class ProfileEventSummaryReport
    ...
    def generate_profile_stats(record, profile, profile_events) 
      ...
      # gather up some gift models for calculating some stats
      event_gifts = {
        gift_liked: [],
        gift_disliked: [],
        gift_selected: [],
      ...
      record[:both_gifts_selected_count] = both_selected_gifts.size
      record[:both_recommended_gifts_selected_count] = (both_selected_gifts & non_random_gifts).size
      record[:recommended_gifts_selected_count] = (event_gifts[:gift_selected] & non_random_gifts).size

      both_liked_gifts = event_gifts[:gift_liked] & gift_events[:recipient_gift_liked]
      record[:both_gifts_liked_count] = both_liked_gifts.size
      record[:both_recommended_gifts_liked_count] = (both_liked_gifts & non_random_gifts).size
      record[:recommended_gifts_liked_count] = (event_gifts[:gift_liked] & non_random_gifts).size

      both_disliked_gifts = event_gifts[:gift_disliked] & gift_events[:recipient_gift_disliked]
      record[:both_gifts_disliked_count] = both_disliked_gifts.size
      record[:both_recommended_gifts_disliked_count] = (both_disliked_gifts & non_random_gifts).size
      record[:recommended_gifts_disliked_count] = (event_gifts[:gift_disliked] & non_random_gifts).size
